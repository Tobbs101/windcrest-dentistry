...
export const blogCategories: BlogCategory[] = [
  ...
  { id: "grammar-schools", name: "Grammar Schools", slug: "grammar-schools" },
  { id: "11-plus", name: "11+ Preparation", slug: "11-plus" },
  { id: "study-tips", name: "Study Tips", slug: "study-tips" },
...
<strong>Let’s help your child break limits and reach their full potential.</strong>
 `,
  },
  {
    id: "what-is-11-plus",
    image: image2,
    title: "What Is the 11+? A Parent's Guide to Grammar School Entry",
    excerpt:
      "If you're exploring grammar school options for your child, you've likely come across the term 11+. But what exactly is it, and how can you help your child succeed?",
...
At Limit Breakers, we specialise in guiding families through the 11+ journey—starting with the right knowledge and preparation.

 <strong>What Is the 11+ Exam?</strong>
The 11+ (Eleven Plus) is an entrance exam used by grammar schools and some independent schools in England to determine Year 7 admission. It's typically taken in September of Year 6, when children are around 10 or 11 years old.

The exam is designed to assess your child's academic ability and potential.

<strong>What Subjects Are Covered?</strong>
The 11+ assesses a mix of subjects and skills, depending on your local authority or school:

- **Maths** – number fluency, reasoning, problem-solving
...
- **Non-Verbal Reasoning** – logic and pattern recognition using shapes and diagrams

 <strong>Why Is the 11+ Important?</strong>
Passing the 11+ gives your child access to selective grammar schools known for their strong academic results, structured learning, and progression to top sixth forms and universities.

But 11+ prep does more than open school doors—it builds:
<strong>- Confidence in exams</strong>
<strong>- Analytical thinking</strong>
<strong>- Independent study habits</strong>
<strong>- A mindset for long-term success</strong>

 <strong>When Should You Start Preparing?</strong>
Most children take the 11+ in Year 6, but effective preparation begins in Year 4 or Year 5.

Starting early helps your child:
<strong>- Learn gradually without pressure</strong>
<strong>- Identify and close knowledge gaps</strong>
...
Start today at <strong><a class='hover:underline' href="https://www.limitbreakers.co.uk" target="_blank">www.limitbreakers.co.uk</a></strong>
  ...
  {
    id: "top-5-study-techniques",
    image: image2,
    title: "Top 5 Study Techniques for Exam Success",
    excerpt:
      "Discover proven strategies to retain information better and ace your exams with these effective study methods.",
    category: "Study Tips",
